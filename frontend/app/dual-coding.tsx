  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>Resolva o mesmo problema{' \n'}em duas linguagens simultaneamente</Text>
        <View style={styles.featureList}>
          <Text style={styles.featureItem}>• Compare sintaxes lado a lado</Text>
          <Text style={styles.featureItem}>• Aprenda padrões entre linguagens</Text>
          <Text style={styles.featureItem}>• Desafios multi-linguagem</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  title: { color: COLORS.neonYellow, fontSize: FONT_SIZES.body, fontWeight: '700', fontFamily: 'SpaceMono', letterSpacing: 1 },
  content: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: SPACING.xl },
  emoji: { fontSize: 80, marginBottom: SPACING.l },
  comingSoon: { color: COLORS.neonYellow, fontSize: FONT_SIZES.h2, fontWeight: '700', fontFamily: 'SpaceMono', letterSpacing: 3, marginBottom: SPACING.m },
  ...
  btn: { backgroundColor: COLORS.neonYellow, paddingVertical: 14, paddingHorizontal: 32, borderRadius: 2 },
