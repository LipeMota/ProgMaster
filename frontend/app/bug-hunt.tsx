  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>BUG HUNT</Text>
        <View style={{ width: 28 }} />
      </View>
      <View style={styles.content}>
        <Text style={styles.emoji}>🐛</Text>
        <Text style={styles.comingSoon}>EM BREVE</Text>
        <Text style={styles.description}>Encontre e corrija bugs em código real{' \n'}Aprenda debugging na prática</Text>
        <View style={styles.featureList}>
          <Text style={styles.featureItem}>• Bugs reais de projetos open-source</Text>
          <Text style={styles.featureItem}>• Dicas progressivas</Text>
          <Text style={styles.featureItem}>• Ranking de caçadores de bugs</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  title: { color: COLORS.neonPink, fontSize: FONT_SIZES.body, fontWeight: '700', fontFamily: 'SpaceMono', letterSpacing: 1 },
  content: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: SPACING.xl },
  emoji: { fontSize: 80, marginBottom: SPACING.l },
  comingSoon: { color: COLORS.neonPink, fontSize: FONT_SIZES.h2, fontWeight: '700', fontFamily: 'SpaceMono', letterSpacing: 3, marginBottom: SPACING.m },
  ...
  btn: { backgroundColor: COLORS.neonPink, paddingVertical: 14, paddingHorizontal: 32, borderRadius: 2 },
